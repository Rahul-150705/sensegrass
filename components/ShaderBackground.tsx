...
// ("Halftone Dots"). Zero dependencies: one WebGL canvas that fills its
// parent. Drop it behind your content with
// <div className="relative"><ShaderBackground className="absolute inset-0" />…
// Adapted from Paper Shaders: https://shaders.paper.design/halftone-dots
...
const UNIFORMS = {
  colors: [[0.06666666666666667,0.06666666666666667,0.06666666666666667],[0.9803921568627451,0.9803921568627451,0.9803921568627451],[0.8313725490196079,0.8313725490196079,0.8313725490196079],[0.3215686274509804,0.3215686274509804,0.3215686274509804],[0.3215686274509804,0.3215686274509804,0.3215686274509804],[0.3215686274509804,0.3215686274509804,0.3215686274509804],[0.3215686274509804,0.3215686274509804,0.3215686274509804],[0.3215686274509804,0.3215686274509804,0.3215686274509804]] as [number, number, number][],
  colorCount: 4,
  scale: 1.480,
  intensity: 0.520,
  paramA: 0.510,
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    if (!canvasEl) return
    // Explicitly-typed non-null aliases: TS loses the `if (!x) return` narrowing
    // for the hoisted render()/cleanup closures below, so pin the types here.

    ...
    <div className="bg-ink-soft border border-line rounded-none flex flex-col h-full  overflow-hidden ">
      ...
      <div className="bg-ink border-b border-line px-3.5 py-3 flex items-center justify-between">
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            <h3 className="text-xs font-bold text-bone tracking-tight">Product Blueprint Assistant</h3>
            <p className="text-[10px] text-steel">Modify the proposed product in plain English</p>
          </div>
        </div>
        {messages.length > 0 && (
          <button
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full py-10 text-center space-y-2.5">
            <div className="w-9 h-9 rounded-none bg-ink border border-line flex items-center justify-center">
              <Sparkles className="w-4 h-4 text-molten" />
            </div>
            <div>
              <p className="text-xs font-bold text-bone">Modify the proposed product</p>
              <p className="text-[10px] text-steel max-w-[240px] mx-auto mt-0.5 leading-relaxed">
